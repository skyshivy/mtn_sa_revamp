...
const pleaseEnterFriendNumberStr = "Please enter friend mobile number";
const testLanguageTextStr = 'TestLanguageText';
const bothMsisdnCanBeSameStr = "Both Msisdn can be same";
const enarStr = "EN | AR";
const playStr = "Play";
...
const diyStr = "DIY";
const doItYourStr = "Do It Yourself";
...
const pleaseEnterValidMsisdnStr = "Please enter valid msisdn";
