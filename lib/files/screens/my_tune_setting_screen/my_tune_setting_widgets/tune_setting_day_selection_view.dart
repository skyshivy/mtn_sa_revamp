        ...
        Obx(() {
          ...
          return SizedBox(
            ...
            child: ListView(
              ...
              shrinkWrap: true,
              children: [
                _dayButton(isLessWid ? sStr.tr : sunStr.tr,
                    cont.daysList[0].isSelected!.value, 0, cont),
                _dayButton(isLessWid ? mStr.tr : monStr.tr,
                    cont.daysList[1].isSelected!.value, 1, cont),
                _dayButton(isLessWid ? tStr.tr : tueStr.tr,
                    cont.daysList[2].isSelected!.value, 2, cont),
                _dayButton(isLessWid ? wStr.tr : wedStr.tr,
                    cont.daysList[3].isSelected!.value, 3, cont),
                _dayButton(isLessWid ? tStr.tr : thusStr.tr,
                    cont.daysList[4].isSelected!.value, 4, cont),
                _dayButton(isLessWid ? fStr.tr : friStr.tr,
                    cont.daysList[5].isSelected!.value, 5, cont),
                _dayButton(isLessWid ? saStr.tr : satStr.tr,
...
Widget _dayButton(
  ...
  return Padding(
    ...
    child: CustomButton(
      ...
      title: title,
      onTap: () {
        printCustom("cont.selectedDays ${cont.selectedDays.split(',')}");

        //printCustom("cont.selectedDays ${cont.daysList[i].isSelected}");
